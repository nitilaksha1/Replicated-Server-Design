service ReplicatedBankService {
   ...
   void 	multi_transfer_ack 		(1:string requestID, 2:i32 serverid, 3:i32 timestamp),
   void multi_transfer_server(1:i32 srcuID, 2:i32 targuID, 3:i32 amount, 4:i32 timestamp, 5:i32 serverid, 6:string requestID)
   void halt()
   void stop_execution(1:i32 timestamp)
