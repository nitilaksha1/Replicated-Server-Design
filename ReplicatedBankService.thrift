...
service ReplicatedBankService {
   ...
   string 	multi_transfer 			(1:i32 srcuID, 2:i32 targuID, 3:i32 amount, 4:TimeStamp timestamp, 5:i32 serverid),
   ...
   oneway void multi_transfer_server(1:i32 srcuID, 2:i32 targuID, 3:i32 amount, 4:TimeStamp timestamp, 5:i32 serverid, 6:string requestID)
   void halt()
